...
const NFTCard = ({ nftItem, title, listings }) => {
  ...
  //listed module ==> price of the NFT.
  // nfts module ==> description of the selected NFT.
  // We are pulling everything from the thirdweb NFT marketplace.

  console.log(listings);
  console.log(nftItem);

  useEffect(() => {
    // It finds the matches and list their prices.
